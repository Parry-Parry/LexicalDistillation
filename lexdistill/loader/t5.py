...
class T5LCETeacherLoader:
    ...
    def __getitem__(self, idx):
        ...
        for neg_item in item['doc_id_b'][:self.num_negatives]:
            ...
            x.append(self.format(self.queries[item['qid']], self.docs[item[neg_item]]))
            y.append(neg_score)
