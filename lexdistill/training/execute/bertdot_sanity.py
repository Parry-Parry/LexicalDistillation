...
from lexdistill.training.models.bertdot import BERTdot
from lexdistill.loss import dotStandardLoss
...
def main(
    ...
    loss_fn = dotStandardLoss(num_negatives=num_negatives)
