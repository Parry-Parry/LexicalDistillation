...
from lexdistill.loader.hf import TripletIDDistilDataset, CatDataCollator, StandardMarginDataset, PerfectMarginDataset, MultiMarginDataset
...
def main(triples_file : str, 
    ...
    if mode=='one-sided':
        ...
        dataset = StandardMarginDataset(teacher_file, triples_file, irds.load(dataset_name), tokenizer, num_negatives=num_negatives, shuffle=False)
    elif mode == 'perfect':
        dataset = PerfectMarginDataset(teacher_file, triples_file, irds.load(dataset_name), num_negatives=num_negatives, shuffle=False)
    elif mode == 'multi':
        dataset = MultiMarginDataset(teacher_file, triples_file, irds.load(dataset_name), num_negatives=num_negatives, shuffle=False)
