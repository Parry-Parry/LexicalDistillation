...
from lexdistill import BERTSingleTeacherLoader, MarginMSELoss, MonoBERTModel
...
def main(
    ...
    loader = BERTSingleTeacherLoader(teacher_file, triples_file, corpus, model.tokenizer, mode=mode, batch_size=batch_size, shuffle=shuffle)
