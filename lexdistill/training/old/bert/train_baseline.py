...
from lexdistill import BERTStandardLoader, BaselineBERT
...
def main(
    ...
    loader = BERTStandardLoader(triples_file, corpus, model.tokenizer, batch_size=batch_size, shuffle=shuffle)
